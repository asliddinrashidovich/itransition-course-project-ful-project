...
function Comments() {
  ...
  return (
    <div className="">
        ...
        {openComments && (
            <div className="bg-[#fff] p-[10px] relative h-[400px] w-[300px] shadow-2xl rounded-[10px] z-[400] ">
                ...
                <form onSubmit={handleAddComment} className="absolute bottom-[10px] left-[10px] right-[10px] rounded-[40px] p-[10px] bg-[#ededed] border-[1px] border-[#999] flex items-center justify-between">
                    <input value={commentText} onChange={(e) => setCommentText(e.target.value)} type="text" className="outline-none" placeholder="Comment"/>
